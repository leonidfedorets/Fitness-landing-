...
(c) kdg http://HtmlWeb.RU/java/example/calendar_kdg.php
 ...
 <label>� <input type="text" name="d_from" size="10" value="{$ar['d_from']}" onfocus="_Calendar.lcs(this)" onclick="_Calendar.lcs(event)" ontouch="_Calendar.lcs(event)" data-yearfrom="-80"></label>
 ����� � /styles.css _Calendar*
 ����� ������ ��������� �������� ����
 _Calendar.YearFrom=-40;
 ����� ������ �������� �������� ����
 _Calendar.YearTo=0;
 ��� ����� �������� � input:  data-yearfrom="-80"
*/
